...
// Reusable Background Components - Tailwind v4
...
export function GradientBlur({ 
  ...
  color?: "rose" | "violet" | "purple" | "blue" | "emerald"
  ...
  return (
    <div className={`absolute ${positions[position]} w-125 h-125 ${colors[color]} rounded-full blur-[120px] pointer-events-none ${className}`} />
  )
}
